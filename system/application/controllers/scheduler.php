...
class scheduler extends Controller {
	...
	function index() {
		...
		$data = array(
			...
			'javascript'=> includeJSFile("jquery") . includeJSFile('jquery.effects') . includeJSFile("schedule_view_maker") . includeJSFile('mschedule_model') . includeJSFile('mschedule_viewcontroller') . includeJSFile('mschedule_new') . includeJSFile("jquery.bubblepopup.v2.3.1.min"),
