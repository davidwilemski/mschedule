...
<div id="signin_menu">
	...
	<?=form_close()?>
	<p class="forgot"> <?=anchor('login/forgot', 'Forgot your username or password?', 'id="forgot_username_link" title="If you remember your password, try logging in with your uniqname"')?></p>
