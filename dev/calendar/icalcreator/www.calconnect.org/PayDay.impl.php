...
$e->setRrule( array( 'FREQ'       => "MONTHLY"
                   , 'BYday'      => array( array( -1, 'DAY' => 'MO' )
                                          ...
                                          , array( -1, 'DAY' => 'FR' ))
                   , 'BYSETPOS'   => -1 ));
$e->setSummary( 'PAY DAY' );
$e->setUid( 'DC3D0301C7790B38631F1FBB@ninevah.local' );
$c->addComponent( $e );
