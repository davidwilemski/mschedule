...
$e = new vevent();
$e->setDtstart( '20050426T100000 Eastern' );
$e->setDtend( '20050426T110000 Eastern' );
$e->setTransp( 'OPAQUE' );
$e->setRdate( array( array( '20050426T100000 Eastern', '20050426T110000' )));
$e->setRecurrenceid( '20050426T130000Z' );
$e->setComment ( "Reschedule of a single instance's time only (+ 1 hr)", array( 'ALTREP' => 'CID:<FFFF__=0ABBE548DFE1E66E8f9e8a93d@coffeebean.com>' ));
$e->setSequence( 1 );
...
$e->setClass( 'PUBLIC' );
$e->setDescription ( 'body', array( 'ALTREP' => 'CID:<FFFF__=0ABBE548DFE230F48f9e8a93d@coffeebean.com>'));
