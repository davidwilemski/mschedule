...
$template 				= 'mschedule';		// Template support
...
$language 				= 'Mschedule';		// Language support - 'English', 'Polish', 'German', 'French', 'Dutch', 'Danish', 'Italian', 'Japanese', 'Norwegian', 'Spanish', 'Swedish', 'Portuguese', 'Catalan', 'Traditional_Chinese', 'Esperanto', 'Korean'
...
$day_end				= '2030';			// End time for day grid
...
$auth_internal_username	= 'mulka';			// Only used if $auth_method='internal'. The username for the administrator.
$auth_internal_password	= 'yarr';			// Only used if $auth_method='internal'. The password for the administrator.
